...
If you already have the Ollama server running on your local machine, you can skip the steps to start the container. Just ensure that the following models are available on your system:
